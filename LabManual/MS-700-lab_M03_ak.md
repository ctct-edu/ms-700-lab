...
4. リストア・グループ
   ...
   2. 左側のナビゲーション ウィンドウで、[**Identity* > **Groups**] を選択します。
   3. **[ グループ** ] ページで、左側のウィンドウの [ **削除されたグループ** ] を選択します。
...
3. グループについて **|[すべてのグループ**] ページで、**CA-Office** グループを検索して選択します。

4. **[CA-Office**] ページで、左側のナビゲーション ウィンドウから [**プロパティ**] を選択します。
...
11. 「概要」ウィンドウで、「**動的ルール処理ステータス**」フィールドを見つけます。
...
4. **[メッセージング ポリシー**の概要] ページに戻り、[**Regular users without fun stuff**] の左側にあるチェックマークを選択します。次に、 [**ユーザーの割り当て]** を選択します
...
4. プライベート チャネルを追加する
   1. 上部のメニューから **[+ 追加**] を選択します。
   2. 「**追加**」ウィンドウで、次の情報を入力します。
      - **名前**: Confidential sales (機密販売)
      - **説明:** 機密のプライベート販売チャネル
      - **タイプ**: 非公開
...
4. 検索結果で **[Google アナリティクス**] を選択して開きます。
...
5. [**インストール済みアプリの追加**] ページで、検索ボックスに**「Tasks by Planner」と「To Do** app」と入力し、名前の上にマウスを合わせて [**追加**] を 2 回選択します。
6. **[Planner と To Do によるタスク**] が [**ピン留めされたアプリ**] セクションに一覧表示されていることを確認し、[**保存**して**確認**] を選択します。
...
4. 次の情報を入力します
   ...
   - 説明: **Adobe Acrobat Sign をインストールし、Viva ゴールをピン留め**します。
   ...
   - ユーザー用のアプリをインストールするには:
     ...
     2. [**インストール済みアプリの追加**] ウィンドウで、ユーザーが Teams を起動したときに自動的にインストールするアプリを検索します。
        ...
        この演習では、「Adobe」を検索し、「**Adobe Acrobat Sign**」を選択し、「追加」を選択して「**追加**する**アプリ**」リストに追加します。
   ...
   - アプリをピン留めするには:
     ...
     2. [**ピン留めされたアプリの追加**] ウィンドウで、[**Viva ゴール**] を検索し、[**追加**] を選択します。
     3. [**保存**] を選択します。
...
2. **営業チームの**アプリ設定ポリシー を選択します。
3. [**ユーザーの割り当て]** を選択します。
4. [**ユーザーの管理**] ウィンドウで、**Alex Wilber** を検索し、[**追加**] を選択します。
5. [**適用]** を選択します。

...
3. Teams の概要で、チームの [**Teams Rollout**]のすぐ横の **[...]** を選択し、ドロップダウン リストから [**Add member(メンバーを追加)**] を選択します。
4. [**Add members to Teams Rollout(Teams Rolloutにメンバーを追加)**] ページで、招待したゲスト ユーザーの名前を入力します。

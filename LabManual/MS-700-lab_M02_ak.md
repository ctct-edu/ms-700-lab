...
​		c. [選択した項目の種類の保護設定を選択します] ページで、[**アクセスの制御**] チェックボックスと [**コンテンツ マーキングを適用する**] チェックボックスをオンにします。

​		d.  [アクセスの制御] ページで、次の操作を行います。 
...
​		e.[コンテンツ マーキング] ページで「コンテンツのマーキング」の下にあるスライダーを選択し、 [**透かしの追加**] チェックボックスを選択します。そのすぐ下の **「テキストのカスタマイズ」**を選択し、透かしテキスト欄に**Internal use only** と入力します。「**保存**」をクリックして変更を適用します。

​	　「フッターの追加」チェックボックスが選択されていることを確認し、そのすぐ下の **「テキストのカスタマイズ」**を選択し、フッターテキスト欄に**Internal use only** と入力します。「**保存**」をクリックして変更を適用します。

​		f. [ファイルとメールの自動ラベル付け] ページで、設定をデフォルトのままにします。

​		g. [グループとサイトの保護設定を定義する] ページで、下記の両方のチェックボックスをオンにします。

​			**プライバシーと外部ユーザーアクセス**

​			**外部共有と条件付きアクセス**

​		h.[プライバシーと外部ユーザー アクセス設定を定義する] ページで、[**なし**] を選択します。

​				※本設定を動作確認するオプションが後であります。

​		i. [外部共有および条件付きアクセスの設定の定義] ページで、

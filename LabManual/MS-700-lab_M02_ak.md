...
7. しばらくすると、新しい会話メッセージの上に「**This message was blocked.」**という赤いテキストが表示されます。**[What can I do?] ** を選択します。このメッセージがブロックされた理由を確認します。
8. DLP ポリシーを正常にテストして、Teams チャットとチャネルの会話を介したクレジット カード情報の共有をブロックしました。
...
6. レポートを作成する
   ...
   2. 次の情報を含むレポートを作成します。
      ...
      - [**計算]** セクションで、次の情報を使用して [**ペルソナ**] と **[ネットワーク ユーザー**] を指定します。
        ...
        | ----------------------- | ------------------------------------ |
        | ニューヨーク本社        | Office Worker:900人 通話のみ:100     |
        | ロサンゼルスオフィス    | Office Worker:200人 通話のみ:50      |

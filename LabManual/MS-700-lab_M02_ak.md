...
3. ゲストの招待を承諾する
   ...
   - Teams Web クライアントから **[チーム**] を選択すると、チーム **Group_Afterwork_** が表示されます。(「チームを見つけることができません」と表示される場合は時間がかかりますので、時間を置いてからTeams Web クライアントへの再サインインを試行してください。)
4. ゲスト アクセスをテストする
   - Group_Afterwork_チームの **[一般(]** チャネルを選択し、 **[投稿を開始する]** を選択して、次のメッセージを送信します: **Hello!**
...
2. Microsoft Purview コンプライアンス ポータルの左側のナビゲーションで、**[ソリューション]**　>  **[Microsoft Information Protection**] > [**秘密度ラベル**] と選択します。
...
​		左側のナビゲーション パネルで [**Microsoft Information Protection**] を選択し、 **[ラベル]** ボタンを選択し、 **[+ ラベルの作成**] を選択し、ウィザードに従って次の情報を入力し、各手順の後に [**次へ**] を選択します。

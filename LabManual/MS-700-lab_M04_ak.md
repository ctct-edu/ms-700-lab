...
2. 左側のナビゲーション ウィンドウで [**音声**] を選択して展開し、次に **[リソース アカウント]** を選択しします。

3. [**リソース アカウント**] ページで、上部のウィンドウから [**+ 追加**] を選択します。

4. 右側のペインで、次の情報を入力します。

   - 表示名: **Contoso 呼び出しキュー リソース アカウント**
   - ユーザー名:**pilot_callqueue1**
   - ドメイン名:**YourTenant.onmicrosoft.com** (「YourTenant」は提供された 名前に置き換え)
   - リソース アカウントの種類: **通話キュー**

5. [**保存**] を選択します。

6. 以下のリンク先にジャンプし、ダウンロードアイコン（下向き矢印）をクリックして、 **Alarm03.wav**ファイルをダウンロードし、ダウンロードフォルダに保存します。

   https://github.com/MicrosoftLearning/MS-700-Managing-Microsoft-Teams/blob/master/Instructions/Labs/media/Alarm03.wav

7. 左側のナビゲーション ウィンドウで、 **[通話キュー]** を選択します。

8. 上部のウィンドウから [**+ 追加**] を選択します。
...
9. 次の情報を入力します。
   ...
   - 言語: **日本語 (日本)** を選択し、 [**次へ**] を選択します。

   - 応答メッセージ: [**音声ファイルを再生する**] を選択し、[**ファイルをアップロード**] を選択します。
...
11. [通話フロー] ページで、次のように構成します。
    ...
    - 「**いらっしゃいませ。あなたが電話した相手は現在休暇中のため、あなたの電話はオペレーターにリダイレクトされます。**」と入力します。
